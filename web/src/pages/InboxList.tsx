...
export function InboxList() {
  ...
  const visibleRows = useMemo(() => rows.filter((r) => {
    ...
    if (filter === 'resolved') return r.status === 'chain_verify';
    return true;
  }), [rows, filter]);
