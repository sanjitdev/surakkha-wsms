# Wireframe Mirror - operator-dashboard

> **Mirror of:** [`../specs/operator-dashboard.md`](../specs/operator-dashboard.md)  
> **Status:** Wireframe view (navigable navigation copy)  
> **Source of truth:** the canonical spec at `../specs/operator-dashboard.md`
