# Wireframe Mirror - per-incident-chain-segment

> **Mirror of:** [`../specs/per-incident-chain-segment.md`](../specs/per-incident-chain-segment.md)  
> **Status:** Wireframe view (navigable navigation copy)  
> **Source of truth:** the canonical spec at `../specs/per-incident-chain-segment.md`

This file mirrors the spec for the wireframe view. Edits should land in `../specs/` first; regenerate this mirror when the spec changes.
