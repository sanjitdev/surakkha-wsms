# Wireframe Mirror - citizen-status-timeline

> **Mirror of:** [`../specs/citizen-status-timeline.md`](../specs/citizen-status-timeline.md)  
> **Status:** Wireframe view (navigable navigation copy)  
> **Source of truth:** the canonical spec at `../specs/citizen-status-timeline.md`
