# Wireframe Mirror - styleguide-page

> **Mirror of:** [`../specs/styleguide-page.md`](../specs/styleguide-page.md)  
> **Status:** Wireframe view (navigable navigation copy)  
> **Source of truth:** the canonical spec at `../specs/styleguide-page.md`
